...
public class CtrlClientes implements ActionListener {  
    ...
    */
    ...
    private final frmClientes vista;   //Clase que representa la interfaz de usuario para la gestión de Clientees
    
    //Constructor
    //Toma 3 parámetros (modelo, consultas y vista) que son objetos de la clase
    //"Clientes", "ConsultasClientes" y "frmClientes"
    public CtrlClientes(Clientes modelo, ConsultasClientes consultas, frmClientes vista){           
        this.modelo = modelo;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vista.btnBuscar) {
            ...
            if (consultas.buscar(modelo)) {
             ...
             // vista.txtEstado.setText(modelo.getEstado());        // Campo jText eliminado del formulario
